...
//{
  ...
  strcat(a,"ZPredictor.pdf");
  strcat(b,"ZPredictorNormal.pdf");
  ...
  std::vector<std::string> nm = {R"((L-R) Photon Ratio as Z-Predictor (ln(LR Ratio) by m))","(L-R) Photon Ratio as Z-Predictor"};
