...
//{
  ...
  strcat(a,"YPredictor.pdf");
  strcat(b,"YPredictorNormal.pdf");
  ...
  std::vector<std::string> nm = {R"((L-R) Photon Ratio as Y-Predictor (ln(LR Ratio) by m))","(L-R) Photon Ratio as Y-Predictor"};
